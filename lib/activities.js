...
Meteor.startup(function() {
  if (Meteor.isServer && Activities.find().count() === 0) {
    Activities.insert({
      text: 'Preview of photoset feature Cellas Closet and Sabrina Sew &amp; Sew!',
      image: '/img/activity/activity-placeholder-640x690.jpg',
      music: 'St. Vincent',
      userAvatar: '/img/activity/avatar-placeholder.jpg',
      userName: 'Sabrina Loyless',
      place: 'Austin, Texas',
      date: new Date
    });
  }
